...
<html lang="en">
  ...
  <body class="bg-gray-900 text-white flex flex-col min-h-screen">
    <header class="fixed top-0 left-0 w-full bg-gray-800 bg-opacity-75 p-4 shadow-lg z-10">
      <div class="max-w-5xl mx-auto flex justify-between items-center">
        ...
        <div class="flex space-x-4">
          <a href="https://ttron.eu" class="bg-white hover:bg-gray-300 text-black font-bold py-2 px-4 rounded">
            Accueil
          </a>
    ...
    <main class="flex-grow flex flex-col items-center justify-center pt-20">
      <h1 class="text-5xl font-bold text-center mb-4">Le Serveur Web Fonctionne !</h1>
